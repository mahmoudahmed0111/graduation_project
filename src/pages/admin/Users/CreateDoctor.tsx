...
export function CreateDoctor() {
  ...
  const onSubmit = async (data: DoctorFormData) => {
    try {
      ...
      logger.info('Doctor created successfully', { context: 'CreateDoctor', data });
      success('Doctor created successfully');
      navigate('/dashboard/users/doctors');
    } catch (err: unknown) {
      logger.error('Failed to create doctor', { context: 'CreateDoctor', error: err });
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Create New Doctor</h1>
